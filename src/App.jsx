...
function App() {
  ...
  return (
    <>
      <div className="flex lg:flex-row flex-col 2xl:gap-24 xl:gap-14 gap-5 bg-white 2xl:py-12 xl:py-8 2xl:px-24 xl:px-14 px-5 py-5 lg:h-screen">
        <div className="lg:w-[50%] py-8 flex flex-col justify-between">
          {/* logo */}
            ...
            <div className="pt-8 flex flex-col space-y-5">
              <div className="relative w-full">
                <input
                  ...
                  className={`peer w-full h-[78px] border-2 border-dark-50 rounded-full px-6 pt-2 pb-2 text-xl text-gray-900 placeholder-gray-400 focus:placeholder-opacity-100 placeholder-opacity-0  focus:outline-none focus:border-primary bg-bg focus-visible:border-2 focus-visible:border-primary ${
        ...
        peer-focus:-top-4 peer-focus:text-xl peer-focus:text-primary peer-focus:px-3 peer-focus:left-8"
              ...
              <div className="relative w-full">
                <input
                  ...
                  className={`peer w-full h-[78px] border-2 border-dark-50 rounded-full px-6 pt-2 pb-2 text-xl text-gray-900 placeholder-gray-400 focus:placeholder-opacity-100 placeholder-opacity-0  focus:outline-none focus:border-primary bg-white focus-visible:border-2 focus-visible:border-primary ${
        ...
        peer-focus:-top-4 peer-focus:text-xl peer-focus:text-primary peer-focus:px-3 peer-focus:left-8 "
                ...
                <button
                  ...
                  className="border border-dark-50 hover:border-primary p-3 rounded-full cursor-pointer absolute top-3 right-2 text-dark-200 hover:text-primary"
                >
                  {isVisible ? (
                    <IoMdEye className="size-[30px]" />
                  ) : (
                    <IoMdEyeOff className="size-[30px]" />
                  )}
                </button>
              </div>
              <a
                href="#"
                className="text-end text-primary-200 hover:text-primary text-lg"
              >
                Forget Password?
              </a>
              ...
              <div>
                ...
                <div className="flex items-center justify-center gap-6">
                  <button className="border border-dark-50 hover:border-primary hover:text-primary text-dark-200 p-3 rounded-full cursor-pointer">
          ...
          <p className="text-lg text-dark-100 text-center">
            ...
            <span className="text-primary-200 hover:text-primary">
              Sign Up Now
            </span>
          </p>
        </div>
